...
namespace CoffeeShop
{
	...
	void V8Engine::start(std::vector<V8Actor*> v8actors)
	{
		context.reset(new SimulationContext(toActors(v8actors), std::move(m_producer));
	}

	void V8Engine::run(v8::Local<v8::Function> function)
	{
		if (context == nullptr)
		{
			return;
	...
	bool V8Engine::endConditionMet(v8::Local<v8::Function>& function, v8::Isolate* isolate)
	{
